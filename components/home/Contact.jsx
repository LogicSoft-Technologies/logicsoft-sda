...
const CHANNELS = [
  ...
  },
  {
    ...
    sub: "contact@logicsofttechnologies.com",
...
export default function ContactSection() {
  ...
  const handlePhone = (e) => {
    ...
    if (d.length > 3 && d.length <= 6) d = d.slice(0, 3) + " " + d.slice(3);
      ...
      d = d.slice(0, 3) + " " + d.slice(3, 6) + " " + d.slice(6, 10);
    setPhone(d);
  };
              ...
              <div className="relative flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-[13px] text-gray-500 mt-1 leading-relaxed">
                    Tell us about your project. Our solution architects respond
                    within 24 hours.
                  </p>
                </div>
              ...
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-[13.5px] text-gray-500 leading-relaxed max-w-sm mx-auto mb-6">
                    A LogicSoft solution architect will review your brief and
                    respond within 24 business hours. Check your inbox and spam
                    folder, just in case.
                  </p>
                  <button
                    onClick={resetForm}
                ...
                >
                      ...
                      <span className="text-[13px] text-gray-500 group-hover:text-[#1f3a5f] transition-colors">
                        {fileName ? (
                          ...
                          <>
                            ...
                            <span className="text-[#1f6fb2] font-semibold">
                              Browse files
                            </span>
                          </>
                        )}
                      </span>
                      <span className="ml-auto text-[10.5px] text-gray-400 shrink-0">
                        Max 10MB
                      </span>
                    </label>
                    <input
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="relative">
                        <select
                          {...field("service")}
                          className="cs-input appearance-none pr-8 cursor-pointer"
                        >
                  ...
                  {submitError && (
                    <div className="flex items-start gap-2.5 px-4 py-3 bg-red-50 border border-red-200">
                      <span className="text-red-500 text-sm shrink-0 mt-0.5">
                        ⚠
                      </span>
                  ...
                  ch.href ? (
                    <li key={i}>
                      <a
                        href={ch.href}
                        target={
                          ch.href.startsWith("https") ? "_blank" : undefined
                        }
                ...
                {[
                  {
                    n: "1",
                    t: "Review",
                    b: "A solution architect reads your brief and researches your context.",
                  },
                  {
                    n: "2",
                    t: "Discovery call",
                    b: "30-minute call to align on scope, timeline, and approach.",
                  },
                  {
                    n: "3",
                    t: "Proposal",
                    b: "Scoped proposal with deliverables and pricing within 5 days.",
                  },
                ].map((s) => (
