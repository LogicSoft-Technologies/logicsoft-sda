...
/**
 * ContactSection.jsx — LogicSoft Technologies
 * ─────────────────────────────────────────────
 * The original ContactSection layout — 2-col card (white form left +
 * blue-gradient sidebar right) — upgraded with ALL functional features
 * from the full ContactPage:
 *
 *  • Full form state: name, company, email, service, budget, message
 *  • Submit handler with loading spinner + AnimatePresence success screen
 *  • Voice recording via MediaRecorder API with live pulse indicator + playback
 *  • File upload: multi-file, filename display, 10MB limit
 *  • Country phone picker: ReactCountryFlag + createPortal dropdown
 *  • IP-based country auto-detection via ipapi.co
 *  • Phone number auto-formatting (000 000 0000)
 *  • GSAP ambient blob animation on background
 *  • Service & budget <select> dropdowns
 *  • Orange gradient submit button with CSS shimmer animation
 *  • Privacy policy link
 *  • SSL secured badge (using Shield icon as fallback)
 *  • Sidebar: Phone, Email, WhatsApp, Live Chat channels
 *  • Sidebar: Media/press + Careers links
 *  • Form validation (required fields)
 *
 * Dependencies:
 *   react-country-flag, framer-motion, lucide-react, gsap
 *
...
const CHANNELS = [
  ...
  },
  {
    ...
    href: null, // triggers live chat widget
    hoverColor: "#7c3aed",
  },
];
...
export default function ContactSection() {
  ...
  useEffect(() => {
    ...
    // Dynamic import — GSAP may not be installed; fall back gracefully
    import("gsap")
      .then(({ gsap }) => {
        gsap.to(blobs, {
      ...
      .catch(() => {
        // GSAP unavailable — CSS animation handles fallback
      });
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    //   body: JSON.stringify({ ...formData, phone: `${country.dial} ${phone}` }),
    // });
  ...
  // Auto-detect visitor's country from IP
  useEffect(() => {
  ...
  return (
    <section className="relative py-16 bg-[#f5f8fc] overflow-hidden">
      ...
      {/* Ambient blobs — animated by GSAP on mount */}
      ...
      <div className="relative z-10 max-w-[82rem] mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 overflow-hidden shadow-lg">
          ...
          {/* ══════════════════════════════════════════
              LEFT — White form card (lg:col-span-2)
          ══════════════════════════════════════════ */}
          <div className="lg:col-span-2 bg-white">
            ...
            >
              ...
              <div className="relative flex items-start justify-between gap-4">
                <div>
                  <h2 className="text-[22px] font-bold text-gray-900 pb-1">
                ...
                <div className="shrink-0 flex flex-col items-center gap-1 border border-[#e8eef6] bg-white px-3 py-2.5 text-center">
                  ...
                  <p className="text-[8.5px] font-bold text-[#1f3a5f] uppercase tracking-wider leading-tight">
                    SSL<br />Secured
                  </p>
                </div>
              </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="text-[22px] font-bold text-[#1f3a5f] mb-2">
                    Submission received
                  </h3>
                  <p className="text-[13.5px] text-gray-500 leading-relaxed max-w-sm mx-auto mb-6">
                    ...
                    24 business hours. Check your inbox — and spam folder, just in case.
                  </p>
                  <button
                    onClick={resetForm}
                ...
                >
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        className={`cs-input resize-none ${
                          recording
                            ? "border-red-400 bg-red-50/50 placeholder-red-400"
                            : ""
                        }`}
                      />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div
                        className="flex items-center border border-gray-300 bg-white hover:border-[#1f6fb2] focus-within:border-[#1f6fb2] focus-within:ring-1 focus-within:ring-[#1f6fb2]/20 transition-all duration-150"
                      >
                  ...
                  <div className="flex items-center justify-between gap-4 flex-wrap pt-1">
                    <p className="text-[11.5px] text-gray-400 leading-relaxed max-w-[260px]">
                      ...
                      <Link href="/privacy" className="text-[#1f6fb2] hover:underline">
                        Privacy Policy
                      </Link>
                      . We never share your data.
                    </p>

                    {/* Orange gradient submit button with shimmer */}
                    <button
                      type="submit"
                      disabled={submitting}
                      ...
                      style={{
                        background: "linear-gradient(135deg, #7A2E00 0%, #C45500 50%, #FF7A00 100%)",
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{
                          ...
                          animation: "cs-shimmer 2.5s infinite",
                        }}
                      />
                      {submitting ? (
                        <>
          ...
          <aside className="bg-gradient-to-br from-[#e6f2ff] via-[#f2f8ff] to-[#ffffff] p-8 space-y-8 border-l border-[#bfdbfe]">
            ...
            <div>
              <p className="text-[11px] font-bold text-[#1f3a5f] uppercase tracking-[0.14em] mb-4">
                Direct contact channels
              </p>
              <ul className="space-y-4">
                {CHANNELS.map((ch, i) => (
                  ch.href ? (
                    ...
                    <li key={i}>
                      {/* Live chat — triggers widget (no href) */}
                      <button
                        type="button"
                        onClick={() => {
                          // Trigger your live chat widget here, e.g. window.Intercom?.('show')
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p className="text-[13px] font-semibold text-[#1f3a5f] group-hover:text-[#7c3aed] transition-colors truncate">
                            {ch.label}
                          </p>
                          <p className="text-[11px] text-gray-400 truncate">{ch.sub}</p>
                        </div>
            ...
            {/* Media & press */}
            <div>
              <p className="text-[11px] font-bold text-[#1f3a5f] uppercase tracking-[0.14em] mb-3">
                Media & press
              </p>
              <a
              ...
              >
                ...
                <div>
                  <p className="text-[13px] font-semibold text-[#1f3a5f] group-hover:text-[#1f6fb2] transition-colors">
                    Request executive insights
                  </p>
