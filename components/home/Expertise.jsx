...
function ServiceCard({ item }) {
  ...
  return (
    <div className="group relative bg-white flex flex-col border border-gray-200 px-5 pt-5 pb-4 overflow-hidden hover:border-[#1f6fb2] hover:shadow-md transition-all duration-300 min-h-[140px]">
      ...
      {/* Arrow */}
      <ArrowUpRight
        className="absolute top-3 right-3 w-[14px] h-[14px] text-gray-300 transition-all duration-300 group-hover:rotate-45 group-hover:text-[#1f6fb2]"
        aria-hidden="true"
      />

      {/* Icon badge */}
      <div
        className="mb-3 w-10 h-10 flex items-center justify-center border shrink-0"
      ...
      {/* Title */}
      <p className="text-[13.5px] font-semibold text-[#1f3a5f] leading-snug group-hover:text-[#1f6fb2] transition-colors duration-200 pr-4">
        {item.title}
      </p>
