...
const ServiceCard = ({ service, large = false }) => {
  ...
  return (
    ...
    >
      ...
      <h3
        className={`font-semibold text-[#1f3a5f] leading-snug mb-2 group-hover:text-[#1f6fb2] transition-colors duration-200 ${large ? "text-[15px] sm:text-[17px]" : "text-[14px] sm:text-[15px]"}`}
      >
        {service.title}
      </h3>
    ...
    >
      <div className="max-w-[82rem] mx-auto px-4 sm:px-6">
        ...
        <p className="text-[15px] sm:text-[17px] text-gray-700 leading-[1.85] sm:leading-[2] mb-10 sm:mb-14 max-w-[1100px]">
          ...
          cybersecurity, cloud infrastructure, and round-the-clock support. Each
          practice is staffed by dedicated specialists with deep domain
          expertise.
        </p>
