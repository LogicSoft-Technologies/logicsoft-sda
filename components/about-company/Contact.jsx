...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative py-20 bg-[#f5f5f5] border-t border-gray-200 overflow-hidden"
    >
      {/* Animated blobs */}
      ...
      <div className="relative z-10 max-w-[82rem] mx-auto px-6">
        ...
        <p className="text-[17px] text-gray-700 leading-[2] mb-14 max-w-[1100px]">
          Engage our engineering and consulting teams to discuss enterprise
          software development, cloud infrastructure, and digital transformation
          initiatives.
        </p>
          ...
          <div>
            ...
            {submitted ? (
              <div className="py-12 text-center">
                ...
                <h3 className="text-[20px] font-serif text-[#1f3a5f] mb-2">
                  Submission received
                </h3>
                ...
                <button
                  onClick={resetForm}
                  className="text-sm font-semibold text-[#1f6fb2] hover:text-[#1f3a5f] transition-colors"
                >
              ...
              <form onSubmit={handleSubmit}>
                ...
                {audioUrl && (
                  <audio controls src={audioUrl} className="mb-4 w-full h-9" />
                )}
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                  ...
                  <span>
                    ...
                    <label
                      htmlFor="upload"
                      className="text-[#1f6fb2] cursor-pointer hover:underline"
                    >
                      {fileName ? (
                ...
                {submitError && (
                  <div className="flex items-start gap-2 px-4 py-3 bg-red-50 border border-red-200 mb-4">
                    <span className="text-red-500 shrink-0 mt-0.5 text-sm">
                      ⚠
                    </span>
            ...
            <ul className="space-y-4 text-sm text-gray-700">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 hover:text-[#1f6fb2] transition"
                >
                  <Image
