...
const guarantees = [
  {
    ...
    description:
      "We don't expect all clients to arrive with a full specification. If you have high-level requirements only, we dive in, ask the right questions, and surface non-obvious needs and goals.",
  ...
  },
  {
    ...
    description:
      "Our thorough discovery work gives us a complete project scope, enabling precise cost estimates. We factor in risk and actively pursue cost optimisation where possible.",
  ...
  },
  {
    ...
    description:
      "We work out granular requirements at the start and stay responsive throughout. The result is software that meets your current goals — even if those goals evolved over time.",
  ...
  },
  {
    ...
    description:
      "We assess the expertise level your project demands and select team members accordingly. Clients get optimal resource costs and guaranteed high team performance.",
  ...
  },
  {
    ...
    description:
      "We evaluate operational, business, technology, and external risk factors — then plan mitigation strategies so we can react quickly and confidently to any disruption.",
  ...
  },
  {
    ...
    description:
      "We manage evolving requirements by working in sprints — each covering a full cycle of feature ideation, development, testing, and deployment from a prioritised backlog.",
  ...
  },
  {
    ...
    description:
      "We're flexible to change — but every change request is assessed for feasibility and desirability before it enters the project, keeping the process firmly under control.",
  ...
  },
  {
    ...
    description:
      "Realistic estimates backed by a risk mitigation plan, thorough change-request management, and continuous budget monitoring throughout the full project lifecycle.",
  ...
  },
  {
    ...
    description:
      "Work decomposition, clear project documentation, and regular retrospectives allow us to manage project time effectively and deliver on schedule.",
  ...
  },
  {
    ...
    description:
      "We establish tailored communication flows and choose the right cadence and format to ensure seamless cooperation between all stakeholders on both sides.",
  ...
  },
  {
    ...
    description:
      "We report regularly on agreed KPIs and provide progress forecasts so clients are always in the loop — no surprises, no ambiguity.",
  ...
  },
  {
    ...
    description:
      "All important decisions and processes are documented to prevent data silos and knowledge loss, ensuring continuity across the full project team.",
          ...
          {guarantees.map((item, index) => {
            ...
            return (
              <Link
                ...
                className="group relative bg-white flex flex-col border border-gray-200 px-6 pt-7 pb-6 overflow-hidden hover:border-[#1f6fb2] hover:shadow-md transition-all duration-300"
              >
                {/* Top slide-in line */}
                <span
                ...
                >
                  <Icon size={20} style={{ color: item.iconColor }} aria-hidden="true" />
                </div>
