      ...
      <div className="max-w-[82rem] mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start pb-20">
          ...
          <div>
            ...
            <h1 className="text-[36px] lg:text-[50px] font-serif font-normal text-[#1f3a5f] leading-[1.12] mb-4">
              About LogicSoft —
            </h1>

            <h2 className="text-[18px] text-[#1f6fb2] font-medium mb-6 leading-snug">
              Your Partner for Project Success
            </h2>

            <p className="text-[16px] text-gray-600 leading-[1.85] max-w-[520px] mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href="/services"
                className="flex items-center gap-2 px-6 py-2.5 text-[13.5px] font-medium
            ...
            <div className="mt-10 w-16 h-[3px] bg-[#1f6fb2]" />
          </div>
          ...
          <div className="relative w-full overflow-hidden bg-white border border-gray-200 shadow-sm">
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-t border-gray-100">
              ...
              <span className="ml-auto text-[11px] text-gray-400 truncate max-w-[200px]">
