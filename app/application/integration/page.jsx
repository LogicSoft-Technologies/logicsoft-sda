...
export default function ApplicationIntegrationPage() {
  return (
    <ServicePageLayout
      ...
      stats={[
        { value: "50+", label: "Integration patterns implemented" },
        { value: "99.95%", label: "Integration uptime SLA" },
        { value: "20+", label: "Third-party connectors built" },
      ]}
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
        ...
        <CapCard icon="🤝" title="Third-Party Connectors" body="Salesforce, SAP, HubSpot, Stripe, and 20+ other platform integrations built and maintained." />
