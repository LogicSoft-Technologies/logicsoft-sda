...
const STATS = [
  ...
  { icon: Users,  val: "300+",  label: "Projects delivered"       },
  { icon: Globe,  val: "5",     label: "Continents served"        },
  { icon: Shield, val: "12+",   label: "Years of practice"        },
];
...
function FAQItem({ q, a }) {
  ...
  return (
    <div className="border-b border-[#e8eef6]">
      ...
      >
        <span className="text-[14.5px] font-semibold text-[#1f3a5f] group-hover:text-[#1f6fb2] transition-colors leading-snug">
          {q}
        </span>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <p className="text-[13.5px] text-gray-500 leading-relaxed pb-5 max-w-2xl">
              {a}
            </p>
          </motion.div>
        )}
  ...
  return (
    <motion.div
      ...
      className={`relative border p-6 transition-all duration-200 ${
        office.primary
          ? "border-[#1f6fb2]/40 bg-[#f0f7ff]"
          : "border-[#e8eef6] bg-white hover:border-[#1f6fb2]/30 hover:shadow-sm"
      }`}
    >
      {office.primary && (
        <div className="absolute top-0 left-0 right-0 h-[3px] bg-[#1f6fb2]" />
      )}
      <div className="flex items-center gap-3 mb-4">
        ...
        {office.primary && (
          <span className="ml-auto text-[9.5px] font-bold text-[#1f6fb2] border border-[#1f6fb2]/30 bg-[#e0f0ff] px-2 py-0.5 uppercase tracking-wider">
            HQ
          </span>
        )}
      </div>
      <div className="space-y-2.5">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <a href={`tel:${office.phone.replace(/\s/g, "")}`} className="text-[12.5px] text-gray-500 hover:text-[#1f6fb2] transition-colors">
            {office.phone}
          </a>
        </div>
        <div className="flex items-center gap-2.5">
...
export default function ContactPage() {
  ...
  // Blob animation (pure CSS fallback if GSAP not loaded)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-white pt-[80px]">
      ...
      {/* ══════════════════════════════════════════════════════
          HERO — dark navy, dot grid, ambient blobs, stat row
      ══════════════════════════════════════════════════════ */}
      <section
      ...
      >
        {/* Dot grid texture (from cybersecurity page) */}
        <div
        ...
        {/* Ambient blobs (from contact section) */}
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, transparent 0%, transparent 49.5%, rgba(31,111,178,0.08) 49.5%, rgba(31,111,178,0.08) 50.5%, transparent 50.5%)",
          }}
        />
          ...
          <div className="py-14 lg:py-18 grid lg:grid-cols-[1fr_auto] gap-12 items-end">
            ...
            >
              ...
              <h1 className="text-[42px] lg:text-[60px] font-serif text-white leading-[1.04] mb-5">
                ...
                <span className="text-[#1f6fb2]">Something</span> Together
              </h1>

              <p className="text-[16px] text-white/50 leading-[1.95] max-w-[520px]">
                Whether you have a defined brief or an open challenge — our solution
                architects will listen, scope, and propose a path forward. No sales
                pressure. No commitment required.
              </p>
            </motion.div>

            {/* Stat chips — from cybersecurity page */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.55, delay: 0.2 }}
              className="grid grid-cols-2 gap-2 min-w-[280px]"
            >
              {STATS.map((s, i) => (
                <motion.div
                  key={s.label}
      ...
      {/* ══════════════════════════════════════════════════════
          DIRECT CHANNELS STRIP — full-width, between hero and form
      ══════════════════════════════════════════════════════ */}
        ...
        <div className="max-w-[82rem] mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#dce8f5]">
            {CHANNELS.map((ch, i) => (
              ...
              >
                <div
                  className="w-10 h-10 flex items-center justify-center border border-[#dce8f5] bg-white group-hover:border-[#1f6fb2]/30 group-hover:bg-[#f0f7ff] transition-all duration-200 shrink-0"
                >
                  <ch.icon className="w-4.5 h-4.5 text-[#1f6fb2]" style={{ width: 18, height: 18 }} />
                </div>
                <div className="min-w-0">
                  <p className="text-[13px] font-semibold text-[#1f3a5f] group-hover:text-[#1f6fb2] transition-colors truncate">
                    {ch.label}
                  </p>
      ...
      <section className="relative bg-[#f5f8fc] py-16 overflow-hidden">
        {/* Subtle ambient blobs behind form */}
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <h2 className="text-[26px] font-serif text-[#1f3a5f] mb-3">
                    Submission received
                  </h2>
                  <p className="text-[14px] text-gray-500 leading-relaxed max-w-sm mx-auto mb-8">
                    A LogicSoft solution architect will review your brief and respond within
                    24 business hours. Check your inbox — and your spam folder, just in case.
                  </p>
                  <button
                    onClick={() => {
                      setSubmitted(false);
                      setFormData({ name: "", company: "", email: "", service: "", budget: "", message: "" });
                      setPhone(""); setAudioUrl(null); setFileName(null);
                    }}
                    className="text-[13px] font-semibold text-[#1f6fb2] hover:text-[#1f3a5f] transition-colors"
                  >
                ...
                >
                  {/* Form header */}
                  <div
                    className="relative px-8 pt-8 pb-7 border-b border-[#e8eef6] overflow-hidden"
                  ...
                  >
                    ...
                    <div className="relative">
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          <p className="text-[10.5px] font-bold text-[#1f6fb2] uppercase tracking-[0.15em] mb-2">
                            Schedule a consultation
                          </p>
                          <h2 className="text-[24px] font-serif text-[#1f3a5f] mb-1.5">
                            Tell us about your project
                          </h2>
                          <p className="text-[13px] text-gray-500 leading-relaxed">
                            Our solution architects respond within 24 hours. All engagements begin with a free scoping call.
                          </p>
                        </div>
                  ...
                  <form onSubmit={handleSubmit} className="px-8 py-8 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        {/* Country code + phone — portal dropdown */}
                        <div
                          ref={triggerRef}
                          className="flex items-center border border-[#d1d5db] bg-white hover:border-[#1f6fb2] focus-within:border-[#1f6fb2] focus-within:ring-1 focus-within:ring-[#1f6fb2]/20 transition-all duration-150"
                        >
                          <button
                            type="button"
                            onClick={toggleDrop}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <textarea
                          ...
                          placeholder={
                            recording
                              ? "Recording your voice briefing…"
                              : "Describe your project requirements, challenges, or questions…"
                          }
                          className={`ls-input resize-none ${
                            recording
                              ? "border-red-400 bg-red-50/40 placeholder-red-400"
                              : ""
                          }`}
                        />
                        {recording && (
                        ...
                        <button
                          ...
                          className={`absolute right-3 bottom-3 p-1.5 border transition-all duration-150 ${
                            recording
                              ? "border-red-300 bg-red-50 scale-110"
                              : "border-[#e5e7eb] bg-white hover:border-[#1f6fb2] hover:bg-[#f0f7ff]"
                          }`}
                        >
                          {recording ? (
                      ...
                      >
                        ...
                        <span className="text-[13px] text-gray-500 group-hover:text-[#1f3a5f] transition-colors">
                          {fileName ? (
                            ...
                            <>
                              Upload documentation, diagrams, or specs{" "}
                              <span className="text-[#1f6fb2] font-semibold">Browse files</span>
                            </>
                          )}
                        </span>
                    ...
                    <div className="pt-2 flex items-center justify-between gap-4 flex-wrap">
                      ...
                      <button
                        ...
                        style={{
                          background:
                            "linear-gradient(135deg, #7A2E00 0%, #C45500 50%, #FF7A00 100%)",
                          boxShadow: "0 6px 24px rgba(196,85,0,0.35)",
                        }}
                      >
                        {/* Shimmer overlay */}
                        <span
                          ...
                          style={{
                            ...
                            animation: "ls-shimmer 2.5s infinite",
                          }}
                        />
                        {submitting ? (
                          <>
            ...
            <div className="space-y-5 lg:sticky lg:top-24">
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 bg-[#1f6fb2] flex items-center justify-center shrink-0">
                    <Clock className="w-4 h-4 text-white" />
                  </div>
                  <p className="text-[13.5px] font-bold text-[#1f3a5f]">24-hour response</p>
                </div>
                <p className="text-[12.5px] text-gray-500 leading-relaxed">
                  Every enquiry is reviewed by a solution architect — not an SDR — and responded to within one business day.
                </p>
              </motion.div>
              ...
              >
                <p className="text-[10.5px] font-bold text-[#1f6fb2] uppercase tracking-[0.14em] mb-4">
                  What happens next
                </p>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={s.n} className="flex gap-3">
                      <div className="w-6 h-6 bg-[#1f6fb2] flex items-center justify-center text-white text-[11px] font-bold shrink-0 mt-0.5">
                        {s.n}
                      </div>
                      <div>
              ...
              >
                <a
                  href="mailto:press@logicsoft.ng"
                  className="flex items-center gap-3 p-4 group hover:bg-[#f8fafc] transition-colors"
                >
                  ...
                  <div>
                    <p className="text-[12.5px] font-semibold text-[#1f3a5f] group-hover:text-[#1f6fb2] transition-colors">
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {["ISO 27001", "GDPR", "NDPR", "OWASP", "PCI DSS", "SOC 2"].map((c) => (
                    <span
                      key={c}
                      className="text-[10px] font-bold text-[#1f3a5f] border border-[#e8eef6] bg-[#f8fafc] px-2.5 py-1"
                    >
                      {c}
                    </span>
                  ))}
      ...
      <section className="bg-white border-t border-[#e8eef6] py-16">
        <div className="max-w-[82rem] mx-auto px-6">
          <motion.div
            ...
            className="mb-10"
          >
            <p className="text-[10.5px] font-bold text-[#1f6fb2] uppercase tracking-[0.16em] mb-2">
              Where we are
            </p>
        ...
        <div className="max-w-[82rem] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-16">
            ...
            >
              ...
              <h2 className="text-[28px] font-serif text-[#1f3a5f] mb-4">
                Before you reach out
              </h2>
              <p className="text-[13.5px] text-gray-500 leading-relaxed">
                Answers to the questions we hear most often. Still not sure? Just ask.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 16 }}
      ...
      {/* ══════════════════════════════════════════════════════
          CTA — dark navy (from cybersecurity page pattern)
      ══════════════════════════════════════════════════════ */}
      <section
        className="relative overflow-hidden border-t border-[#1a3258]"
      ...
      >
        ...
        <div className="relative z-10 max-w-[82rem] mx-auto px-6 py-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            <p className="text-[10.5px] font-bold text-[#60a8dc] uppercase tracking-[0.16em] mb-3 font-mono">
              No obligation · No lock-in
            </p>
            <h2 className="text-[28px] font-serif font-normal text-white mb-2">
              Ready when you are.
            </h2>
            <p className="text-[14px] text-white/45 max-w-lg leading-relaxed">
              Start with a conversation. We&rsquo;ll scope the work, provide a proposal,
              and you decide if it&rsquo;s the right fit — zero pressure.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <a
              ...
              style={{
                background: "linear-gradient(135deg, #7A2E00, #C45500 50%, #FF7A00)",
                boxShadow: "0 6px 24px rgba(196,85,0,0.4)",
              }}
            >
            ...
            >
              {COUNTRIES.map((c) => (
                <div
                  ...
                  className={`flex items-center gap-3 px-3 py-2.5 hover:bg-[#f5f9ff] cursor-pointer transition-colors ${
                    country.code === c.code ? "bg-[#eff6ff]" : ""
                  }`}
                >
