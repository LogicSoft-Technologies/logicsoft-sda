            ...
            <div className="shrink-0 grid grid-cols-2 gap-3">
              {COMPANY_STATS.map((s) => {
                ...
                return (
                  <div
                    key={s.label}
                    className="bg-white border border-gray-200 px-5 py-4 min-w-[140px]"
                  >
                    <div className="flex items-center gap-2 mb-1.5">
                      <Icon className="w-3.5 h-3.5 text-[#1f6fb2]" />
                    </div>
                    <p className="text-[32px] font-light text-[#1f3a5f] leading-none mb-1">
                      {s.value}
                    </p>
      ...
      <div className="bg-[#1f3a5f]">
        <div className="max-w-[82rem] mx-auto px-4 py-12">
          <blockquote className="text-[19px] lg:text-[22px] font-serif font-normal text-white leading-[1.65] max-w-[820px]">
            "We didn't set out to build the biggest software company in Africa.
            We set out to build the most trustworthy one and to prove that a
            Nigerian engineering firm could deliver to the same standard as any
            team in London, Dubai, or Silicon Valley."
          </blockquote>
          <p className="text-[12px] text-white/40 mt-4">
            — Logicsoft Technologies Founding Principles, 2021
          </p>
        </div>
      </div>
              ...
              {MILESTONES.map((m, i) => (
                ...
                >
                  <div className="flex gap-0 md:gap-8 items-start">
                    ...
                    {/* Card */}
                    <div
                      className={`flex-1 bg-white border transition-all duration-200 group-hover:shadow-sm group-hover:border-gray-300 ${m.highlight ? "border-l-[3px]" : "border-gray-200"}`}
                      style={{
                        borderLeftColor: m.highlight
                          ? m.accentColor
                          : undefined,
                      }}
                    >
                      ...
                      {m.highlight && (
                        <div className="px-6 pt-3 pb-0">
                          <span
                            className="text-[9px] font-bold uppercase tracking-[0.14em] px-2 py-[3px]"
                            style={{
                      ...
                      <div className="p-6">
                        ...
                        <div
                          className="w-8 h-[2px] mb-3 opacity-40 group-hover:opacity-100 group-hover:w-12 transition-all duration-300"
                          style={{ background: m.accentColor }}
                        />
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {m.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-[10.5px] font-semibold px-2.5 py-1"
                              style={{
                                background: m.accentBg,
                                color: m.accentColor,
                              }}
          ...
          <div className="grid lg:grid-cols-[1fr_1fr] gap-16">
            <div>
              ...
              <p className="text-[14px] text-gray-500 leading-[1.9]">
                We're expanding our engineering capacity in East Africa,
                deepening our presence in the UAE, and investing in AI-augmented
                development tooling that will let our engineers ship more
                reliable software, faster. The principles don't change. The
                ambition does.
              </p>
            </div>
            <div className="flex flex-col gap-4">
              {[
                {
                  label: "East Africa expansion",
                  detail: "Engineering hub in Nairobi — 2025",
                },
                {
                  label: "AI-augmented development",
                  detail:
                    "Proprietary tooling for code review and test generation",
                },
                {
                  label: "MENA office",
                ...
                >
                  <span className="text-[10px] font-mono text-gray-300 mt-1 shrink-0">
