...
const FAQS = [
  {
    ...
    a: "You can raise a support ticket via email to support@logicsoft.com, or through the client portal if your engagement includes one. All tickets are acknowledged within 2 business hours and triaged to the appropriate support level.",
  },
  {
    q: "What is your uptime commitment?",
    a: "Our standard SLA for hosted systems is 99.5% monthly uptime. Enterprise retainer clients receive 99.9% uptime commitments with financial SLA penalties if not met. All uptime is measured and reported monthly.",
  },
  {
    q: "How are incidents classified?",
    a: "P1 (Critical): system down, revenue impact, data loss. P2 (High): major feature unavailable, significant user impact. P3 (Medium): non-critical bug, workaround available. P4 (Low): cosmetic issue, enhancement request. Classification determines response time.",
  },
  {
    q: "Do you offer support for systems you didn't build?",
    a: "Yes. We regularly provide support for systems built by other vendors. We begin with a Technical Audit to establish familiarity with the codebase and architecture before committing to an SLA.",
  },
  {
    q: "What happens during a P1 incident outside business hours?",
    a: "P1 incidents are escalated to an on-call senior engineer immediately, regardless of time. The on-call rotation is staffed 24/7 for clients on L3 support. Response begins within 2 hours of the incident being raised.",
  },
];
...
const CHANNELS = [
  {
    icon: Mail,
    title: "Email Support",
    detail: "contact@logicsofttechnologies.com",
...
const RESOURCES = [
  {
    icon: BookOpen,
    title: "Documentation",
    desc: "Technical documentation, API references, and system guides for all Logicsoft-built systems.",
    href: "/docs",
    label: "Browse docs",
  },
  {
    icon: FileText,
    title: "Runbooks",
    desc: "Step-by-step operational runbooks for common maintenance tasks, deployment procedures, and incident responses.",
    href: "/runbooks",
    label: "View runbooks",
  },
  {
    icon: Users,
    title: "Client Portal",
    desc: "Raise and track support tickets, view SLA status, access monthly reports, and manage your engagement.",
    href: "/portal",
    label: "Access portal",
  },
  {
    ...
    desc: "Service status updates, planned maintenance notifications, and engineering blog posts.",
    href: "/updates",
    label: "View updates",
  },
];
    ...
    <div className="pt-[96px] bg-white">
            ...
            <div className="shrink-0 grid grid-cols-2 gap-3">
              {[
                ...
                return (
                  <div
                    key={s.label}
                    className="bg-white border border-gray-200 px-5 py-4 min-w-[130px]"
                  >
                    <Icon className="w-3.5 h-3.5 text-[#1f6fb2] mb-2" />
                    <p className="text-[28px] font-light text-[#1f3a5f] leading-none mb-1">
                      {s.value}
                    </p>
      ...
      <div className="bg-gradient-to-br from-[#eaf6ff] via-[#dff0ff] to-[#eef7ff] border-b border-gray-200">
        <div className="max-w-[82rem] mx-auto px-4 py-16">
          ...
          <h3 className="text-[28px] lg:text-[36px] font-serif text-[#1f3a5f] mb-12">
            Three levels. One promise: issues get resolved.
          </h3>
            ...
            {SUPPORT_TIERS.map((tier, i) => (
              ...
              >
                <span
                  ...
                  style={{
                    background: `linear-gradient(90deg, ${tier.accentColor}, ${tier.accentColor}55)`,
                  }}
                />
                <div className="p-8">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      ...
                      <h4 className="text-[17px] font-bold text-[#1f3a5f]">
                        {tier.title}
                      </h4>
                    </div>
                  </div>
                  <div
                    className="w-8 h-[2px] mb-5 opacity-30 group-hover:opacity-100 group-hover:w-12 transition-all duration-300"
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-[82rem] mx-auto px-4 py-16">
          ...
          <h3 className="text-[28px] font-serif text-[#1f3a5f] mb-10">
            How to reach us.
          </h3>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            {CHANNELS.map((ch, i) => {
              ...
              return (
                <div
                  key={i}
                  className="group relative border border-gray-200 bg-white hover:border-gray-300 hover:shadow-sm transition-all duration-200 overflow-hidden"
                >
                  <span
                    className="absolute top-0 left-0 right-0 h-[3px] w-0 group-hover:w-full transition-all duration-500"
                    style={{
                      background: `linear-gradient(90deg, ${ch.accentColor}, ${ch.accentColor}44)`,
                    }}
                  />
                  <div className="p-7">
                    <div
                      className="w-10 h-10 flex items-center justify-center mb-5"
                      style={{ background: ch.accentBg }}
                    >
                      <Icon
                        className="w-5 h-5"
                    ...
                    <h4 className="text-[16px] font-bold text-[#1f3a5f] mb-1">
                      {ch.title}
                    </h4>
                    <p
                    ...
                    <div
                      className="w-6 h-[2px] mb-4 opacity-30 group-hover:opacity-100 group-hover:w-10 transition-all duration-300"
                      style={{ background: ch.accentColor }}
                    />
                    <p className="text-[13px] text-gray-500 leading-[1.85] mb-4">
                      {ch.desc}
                    </p>
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.1em] mb-5">
                      {ch.availability}
                    </p>
                    <a
                      href={ch.href}
      ...
      <div className="bg-[#f5f5f5] border-b border-gray-200">
        <div className="max-w-[82rem] mx-auto px-4 py-16">
          ...
          <h3 className="text-[28px] font-serif text-[#1f3a5f] mb-10">
            Resources to help you solve issues faster.
          </h3>
            ...
            {RESOURCES.map((r, i) => {
              ...
              return (
                <div
                  key={i}
                  className={[
                    "group relative px-8 py-9 border-b border-gray-200 bg-white hover:bg-[#f7fbff] transition-colors duration-200",
                ...
                >
                  ...
                  <h4 className="text-[15px] font-bold text-[#1f3a5f] mb-3 group-hover:text-[#1f6fb2] transition-colors">
                    {r.title}
                  </h4>
                  ...
                  <Link
                    href={r.href}
                    className="inline-flex items-center gap-1 text-[12px] font-bold text-[#1f6fb2] opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                  >
          ...
          <div className="grid lg:grid-cols-[360px_1fr] gap-16">
            <div>
              ...
              <p className="text-[14px] text-gray-500 leading-[1.85] mb-8">
                ...
                <a
                  href="contact@logicsofttechnologies.com"
                  className="text-[#1f6fb2] hover:underline"
                >
                  contact@logicsofttechnologies.com
                </a>
                .
              </p>
              <Link
