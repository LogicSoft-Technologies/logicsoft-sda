...
const MODELS = [
    ...
    process: [
      {
        ...
        desc: "Full scope, wireframes, and acceptance criteria agreed and signed off.",
      },
      {
        step: "02",
        title: "Phased milestones",
        desc: "Delivery broken into 2–4 week milestone checkpoints with defined outputs.",
      },
      {
        step: "03",
        title: "Change control",
        desc: "Any scope changes are assessed, priced, and approved separately before implementation.",
      },
      {
        step: "04",
        title: "Final acceptance",
        desc: "Formal sign-off against agreed criteria before final payment and delivery.",
      },
    ],
    featured: false,
  },
  {
    ...
    notFor: [
      "Fixed-budget projects requiring a hard cost ceiling",
      "Simple, fully-specified one-off builds",
    ],
    process: [
      {
        step: "01",
        title: "Rate card agreed",
        desc: "Hourly or daily rates for each role locked in writing before engagement starts.",
      },
      {
        step: "02",
        title: "Sprint planning",
        desc: "Work planned in 2-week sprints. You set priorities at the start of each sprint.",
      },
      {
        step: "03",
        title: "Transparent reporting",
        desc: "Weekly timesheets and progress reports. No hours logged without deliverable context.",
      },
      {
        step: "04",
        title: "Monthly invoicing",
        desc: "Invoiced monthly based on actual hours. No estimates, no approximations.",
      },
    ],
    featured: true,
  },
  {
    ...
    notFor: [
      "Short one-off projects under 3 months",
      "Highly specialised single-skill needs (use team extension instead)",
    ],
    process: [
      {
        step: "01",
        title: "Team composition",
        desc: "We build your team: frontend, backend, mobile, QA, DevOps, and PM as needed.",
      },
      {
        step: "02",
        title: "Onboarding sprint",
        desc: "Team is onboarded to your systems, codebase, and product vision in week one.",
      },
      {
        step: "03",
        title: "Steady-state delivery",
        desc: "Team operates in 2-week sprints. Regular syncs with your leadership.",
      },
      {
        step: "04",
        title: "Scaling up or down",
        desc: "Team size adjusted as product needs change no fixed headcount lock-in.",
      },
    ],
    featured: false,
  },
  {
    ...
    notFor: [
      ...
      "Large feature builds (handled as separate engagements)",
    ],
    process: [
      {
        step: "01",
        title: "System audit",
        desc: "We review your codebase, infrastructure, and incident history before committing.",
      },
      {
        step: "02",
        title: "SLA definition",
        desc: "Response times, escalation paths, and coverage hours agreed in writing.",
      },
      {
        step: "03",
        title: "Monthly hours block",
        desc: "Fixed hours secured each month. Unused hours roll forward by agreement.",
      },
      {
        step: "04",
        title: "Monthly reporting",
        desc: "End-of-month report: hours used, incidents handled, improvements delivered.",
      },
    ],
    featured: false,
  },
...
const COMPARISON = [
  {
    factor: "Scope flexibility",
    fixedPrice: "Low",
    timesMaterials: "High",
    dedicatedTeam: "Very high",
    retainer: "Medium",
  },
  {
    factor: "Budget predictability",
    fixedPrice: "Very high",
    timesMaterials: "Medium",
    dedicatedTeam: "Medium",
    retainer: "High",
  },
  {
    factor: "Client control",
    fixedPrice: "Medium",
    timesMaterials: "High",
    dedicatedTeam: "Very high",
    retainer: "High",
  ...
  {
    factor: "Best project duration",
    fixedPrice: "4–20 wks",
    timesMaterials: "Ongoing",
    dedicatedTeam: "6mo+",
    retainer: "Monthly",
  },
  {
...
const FAQS = [
  {
    ...
    a: "Yes. We've transitioned clients from Fixed Price to T&M as projects evolved. The transition is governed by a simple amendment to the original agreement.",
  },
  {
    q: "Do you offer hybrid models?",
    a: "Absolutely. A common pattern is Fixed Price for Phase 1 (MVP) followed by T&M or a Dedicated Team for Phase 2 onwards.",
  },
  {
    q: "How are rates determined?",
    a: "Rates depend on role seniority, engagement type, and duration. We provide a full rate card during the proposal process. There are no hidden fees.",
  },
  {
    q: "Is there a minimum engagement size?",
    a: "For Fixed Price and T&M projects, our minimum engagement is typically 4 weeks. Retainer engagements start at a 3-month minimum commitment.",
  },
  {
    q: "What's included in a Dedicated Team?",
    a: "Roles are scoped to your needs typically a mix of frontend, backend, QA, DevOps, and a technical lead or architect. You choose the composition.",
  },
];
    ...
    <div className="border-b border-gray-200 last:border-0">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <span className="text-[15px] font-semibold text-[#1f3a5f]">
            {item.q}
          </span>
        </div>
        <span
          className={`shrink-0 w-7 h-7 flex items-center justify-center border transition-all duration-200 ${open ? "border-[#1f6fb2] bg-[#1f6fb2] text-white rotate-180" : "border-gray-200 text-gray-400"}`}
        >
    ...
    <div className="pt-[96px] bg-white">
          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-12 items-end">
            <div>
              ...
              <h2 className="text-[38px] lg:text-[52px] font-serif text-[#1f3a5f] leading-[1.08] mb-5">
                ...
                <span className="text-[#1f6fb2]">Right Model</span> for Every
                Project.
              </h2>
              <p className="text-[17px] text-gray-600 leading-[1.9] max-w-[640px]">
                We don't have one pricing model because no two projects are the
                same. We offer four engagement structures each suited to a
                different project type, risk profile, and client preference. All
                are fully transparent with no hidden fees.
              </p>
            </div>
                ...
                >
                  {isActive && (
                    <span
                      ...
                      style={{
                        background: `linear-gradient(90deg, ${model.accentColor}, ${model.accentColor}55)`,
                      }}
                    />
                  )}
                  {model.featured && (
                    <span className="absolute top-3 right-3 text-[9px] font-bold uppercase tracking-wide px-2 py-[2px] bg-[#1f3a5f] text-white">
                      Most popular
                    </span>
                  )}
                  <div
                    ...
                    style={{
                      background: isActive ? model.accentBg : "#f3f4f6",
                    }}
                  >
                    <MIcon
                      className="w-4 h-4"
                      style={{
                        color: isActive ? model.accentColor : "#9ca3af",
                      }}
                    />
                  </div>
                  <div>
                    <p
                      className={`text-[16px] font-bold mb-1 transition-colors ${isActive ? "text-[#1f3a5f]" : "text-gray-600"}`}
                    >
                      {model.name}
                    </p>
                ...
                <div className="p-8 lg:p-10">
                  <div className="flex items-center gap-3 mb-5">
                    <div
                      ...
                      style={{ background: activeModel.accentBg }}
                    >
                      <Icon
                        className="w-5 h-5"
                    ...
                    <div>
                      ...
                      <h3 className="text-[22px] font-serif font-bold text-[#1f3a5f]">
                        {activeModel.name}
                      </h3>
                    </div>
                  </div>
                  ...
                  />
                  <p className="text-[15px] text-gray-500 leading-[1.9] mb-7">
                    {activeModel.desc}
                  </p>

                  <div className="mb-7">
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.12em] mb-3">
                      Best for
                    </p>
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center gap-2.5 px-7 py-3.5 text-[13.5px] font-bold text-white transition-all duration-200 hover:opacity-90"
                    style={{ background: activeModel.accentColor }}
                  >
                  ...
                  <div className="flex flex-col gap-7">
                    {activeModel.process.map((p) => (
                      <div key={p.step} className="flex gap-4">
                        <div
                          className="shrink-0 w-9 h-9 flex items-center justify-center text-[11px] font-bold font-mono"
                          style={{
                            background: activeModel.accentBg,
                        ...
                        <div>
                          <p className="text-[14px] font-bold text-[#1f3a5f] mb-1">
                            {p.title}
                          </p>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-[82rem] mx-auto px-4 py-16">
          ...
          <h3 className="text-[28px] lg:text-[36px] font-serif text-[#1f3a5f] mb-10">
            Model comparison
          </h3>
            ...
            <table className="w-full border-collapse text-[13px]">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  <th className="text-left py-4 pr-8 text-[11px] font-bold text-gray-400 uppercase tracking-[0.12em] w-[200px]">
                    Factor
                  </th>
                  {MODELS.map((m) => (
                    <th
                      key={m.id}
                      className="text-left py-4 px-4 text-[13px] font-bold text-[#1f3a5f]"
                    >
              ...
              <tbody>
                {COMPARISON.map((row, i) => (
                  ...
                  >
                    <td className="py-3.5 pr-8 text-[13px] font-semibold text-gray-600">
                      {row.factor}
                    </td>
                    {[
                      row.fixedPrice,
                      ...
                      return (
                        <td key={j} className="py-3.5 px-4">
                          <span
                            className="inline-block text-[11.5px] font-semibold px-2.5 py-1"
                            style={{
          ...
          <div className="grid lg:grid-cols-[360px_1fr] gap-16">
            <div>
              ...
              <p className="text-[14px] text-gray-500 leading-[1.85] mb-8">
                Still unsure which model fits? Book a 20-minute call and we'll
                recommend the right structure for your project.
              </p>
              <Link
                href="/contact"
      ...
      <div className="bg-[#1f3a5f]">
        <div className="max-w-[82rem] mx-auto px-4 py-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            ...
            <h3 className="text-[26px] font-serif font-normal text-white mb-2">
              Tell us about your project. We'll recommend the right model.
            </h3>
            <p className="text-[14px] text-white/50 max-w-lg leading-relaxed">
              No commitment required. We'll assess your requirements and tell
              you which pricing model makes the most sense and why.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2.5 px-8 py-4 text-[13.5px] font-bold text-white bg-gradient-to-br from-[#7A2E00] via-[#C45500] to-[#FF7A00] hover:from-[#8F3600] hover:via-[#D46000] hover:to-[#FF8C1A] ring-1 ring-inset ring-white/30 transition-all duration-200"
            >
              Request a proposal <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
