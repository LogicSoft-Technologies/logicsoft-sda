...
const LeafletMap = dynamic(
  () => import("@/components/about-company/LeafletMapClient"),
  { ssr: false },
);
...
const GLOBE_POINTS = [
  ...
  },
  {
    lat: 25.2048,
    lng: 55.2708,
    label: "Dubai — Delivery",
    color: "#34d399",
    size: 0.7,
  },
  { lat: 5.6037, lng: -0.187, label: "Accra", color: "#1f6fb2", size: 0.5 },
...
const REGIONS = [
  {
    ...
    lines: ["Primary HQ and Engineering Hub", "Lagos · Abuja · Edo"],
    iconColor: "#1f6fb2",
    accentBg: "#eaf4ff",
    accentBorder: "#bfdbfe",
  },
  {
    ...
    lines: [
      "Distributed Remote Engineering",
      "Africa · Europe · MENA · Americas",
    ],
    iconColor: "#059669",
    accentBg: "#d1fae5",
    accentBorder: "#6ee7b7",
...
export default function OurLocation() {
  ...
  useEffect(() => {
    ...
    const obs = new IntersectionObserver(([e]) => {
      if (e.isIntersecting) setMapLoaded(true);
    });
    obs.observe(el);
  ...
  const zoomTo = (coords) =>
    mapRef.current?.flyTo(coords, 13, { duration: 1.4 });
  ...
  return (
    <div className="pt-[96px] bg-white">
      ...
      <div
        className="border-t border-b border-gray-200 relative overflow-hidden"
        style={{
          background:
            "linear-gradient(135deg, #0d1f35 0%, #1f3a5f 50%, #1a4a7a 100%)",
        }}
      >
        <div
        ...
        <div className="relative z-10 max-w-[82rem] mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-[1fr_auto] gap-12 items-center">
            <div>
              <p className="text-[11px] font-bold text-[#60a5fa] uppercase tracking-[0.16em] mb-4">
                Where we operate
              </p>
              ...
              <p className="text-[17px] text-white/70 leading-[1.9] max-w-[560px] mb-10">
                Headquartered in Lagos with offices in Abuja and Edo and
                distributed delivery teams serving clients across Africa,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {REGIONS.map((r, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="group relative bg-white/8 border border-white/15 px-5 py-4 hover:bg-white/12 hover:border-white/25 transition-all duration-200 backdrop-blur-sm overflow-hidden"
                    >
                      ...
                      <div
                        className="w-8 h-8 flex items-center justify-center border mb-3"
                        style={{
                      ...
                      {r.lines.map((l, j) => (
                        <p
                          key={j}
                          className="text-[11.5px] text-white/50 leading-snug"
                        >
                          {l}
                        </p>
                      ))}
            ...
            <div className="shrink-0 flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-3 text-[11.5px] text-white/50">
                <span className="flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#1f6fb2]" /> Nigeria
                  offices
                </span>
                <span className="flex items-center gap-1.5">
                ...
                <span className="flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#34d399]" /> MENA
                  delivery
                </span>
              </div>
            </div>
            ...
            {OFFICES.map((office, i) => (
              ...
              >
                <span
                  ...
                  style={{
                    background: `linear-gradient(90deg, ${office.accentColor}, ${office.accentColor}55)`,
                  }}
                />
                <div className="p-7">
                  <div className="flex items-center gap-3 mb-5">
                    <div
                      ...
                      style={{ background: office.accentBg }}
                    >
                      <MapPin
                        className="w-4 h-4"
                    ...
                    <div>
                      <span
                        className="text-[9px] font-bold uppercase tracking-[0.14em] px-2 py-0.5"
                        style={{
                          background: office.accentBg,
                          color: office.accentColor,
                        }}
                      >
                        {office.type}
                      </span>
                      <p className="text-[16px] font-bold text-[#1f3a5f] mt-1">
                        {office.city}
                      </p>
                    </div>
                  </div>
                  ...
                  <div
                    className="w-6 h-[2px] mb-4 opacity-40 group-hover:opacity-100 group-hover:w-10 transition-all duration-300"
      ...
      <div id="leaflet-section" className="bg-white border-b border-gray-200">
        <div className="max-w-[82rem] mx-auto px-4 py-14">
          ...
          <h3 className="text-[28px] font-serif text-[#1f3a5f] mb-5">
            Find us on the map.
          </h3>
          ...
          {/* Map + sidebar */}
          <div
            className="grid md:grid-cols-[1fr_300px] border border-gray-200 bg-white shadow-sm overflow-hidden"
                ...
                >
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1">
                      <p
                        className={`text-[13.5px] font-bold leading-snug mb-0.5 ${activeOffice === i ? "text-[#1f6fb2]" : "text-[#1f3a5f]"}`}
                      >
                        {o.city}
                      </p>
                      ...
                      <button
                        onClick={() => handleOfficeClick(i)}
                        className="mt-2 flex items-center gap-1 text-[12px] font-semibold transition-all"
                        style={{ color: o.accentColor }}
                      >
          ...
          <div className="grid lg:grid-cols-[1fr_1fr] gap-16 items-start">
            <div>
              ...
              <h3 className="text-[28px] font-serif text-[#1f3a5f] mb-5 leading-tight">
                You don't need to be in Lagos
                <br />
                to work with us.
              </h3>
              <p className="text-[14px] text-gray-500 leading-[1.9]">
                Our distributed delivery model means we work effectively with
                clients in any time zone. We cover GMT+0 to GMT+5 with real-time
                overlap, and support asynchronous workflows for clients in the
            ...
            <div className="grid grid-cols-1 gap-3">
              {[
                {
                  region: "West Africa (WAT — GMT+1)",
                  detail: "Real-time collaboration · Full overlap",
                  color: "#1f6fb2",
                },
                {
                  region: "UK & Europe (GMT / BST)",
                  detail: "2–3 hr overlap mornings. Async afternoons",
                  color: "#059669",
                },
                {
                  region: "UAE & MENA (GST — GMT+4)",
                  detail: "Morning overlap. Dubai team embedded for MENA",
                  color: "#d97706",
                },
                {
                  region: "North America (EST/PST)",
                  detail: "Async delivery. PM coverage until 9pm WAT",
                  color: "#7c3aed",
                },
              ].map((r) => (
                <div
                  key={r.region}
                  className="flex items-start gap-4 border border-gray-100 bg-[#f9fafb] px-5 py-4"
                >
                  <span
                  ...
                  />
                  <div>
                    <p className="text-[13.5px] font-bold text-[#1f3a5f]">
                      {r.region}
                    </p>
        ...
        <div className="max-w-[82rem] mx-auto px-4 py-16 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            ...
            <h3 className="text-[26px] font-serif font-normal text-white mb-2">
              Walk into any of our offices. Or book a call from anywhere.
            </h3>
            <p className="text-[14px] text-white/50 max-w-lg leading-relaxed">
              We're reachable by phone, email, or a 30-minute video call.
