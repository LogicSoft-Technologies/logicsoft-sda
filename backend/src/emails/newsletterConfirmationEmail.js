...
<html lang="en">
  <body style="margin:0;background:#f5f8fc;font-family:Arial,Helvetica,sans-serif;color:#1a2d4a;">
    <main style="max-width:600px;margin:32px auto;background:#ffffff;border:1px solid #e8eef6;padding:40px;">
      ...
      <p style="font-size:15px;line-height:1.7;color:#475569;">
        Confirm your email address to receive practical insights on software
        engineering, AI, cloud, cybersecurity, and digital transformation.
      </p>

      <p style="margin:30px 0;">
        <a href="${confirmationUrl}" style="display:inline-block;background:#1f6fb2;color:#ffffff;text-decoration:none;padding:13px 20px;font-size:14px;font-weight:700;">
