...
export const CASE_STUDIES = [
  {
    ...
    description:
      "Full core banking API integration connecting 6 legacy systems into a single, real-time data layer — enabling instant cross-branch reconciliation and automated compliance reporting.",
    featured: true,
    resultBg: "#dbeafe",
    resultText: "#1d4ed8",
    ...
    techStack: ["Node.js", "PostgreSQL", "AWS", "REST API", "Kafka", "Docker", "Redis"],
    testimonial: {
      quote:
  ...
  },
  {
    ...
    category: "Enterprise Platforms",
    image: "/images/saas.png",
    video: "/videos/case-studies/7.mp4",
    year: "2023",
    duration: "6 months",
    outcome: "30% efficiency gain",
    tags: ["Vue.js", "Python", "PostgreSQL", "Google Maps API"],
    description:
      "End-to-end fleet management integrating GPS tracking, driver management, maintenance scheduling, route optimisation, and ERP data sync across 3 countries.",
    featured: false,
    resultBg: "#fff7ed",
    resultText: "#d97706",
    industry: "Logistics & Transportation",
    teamSize: "7 engineers · 1 PM",
    role: "Platform build, route optimization, ERP integration",
    challenge:
      "Gulf Logistics ran fleet operations across three countries using a mix of spreadsheets and a legacy dispatch tool that didn't talk to their ERP, so dispatchers were routing trucks manually and maintenance was scheduled reactively, after something broke.",
    solution:
    ...
    results: [
      { value: "30%", label: "Gain in fleet operational efficiency" },
